...
class ClientHandler extends Thread  { 
    ...
    { 
        ...
        //string en donde se guarda la informacion deserealizada
		...
		while (true)  { 
            try {
                ...
                //se guarda en el string word la palabra obtenida al deserealizar el json
                String word;
                int puntaje;
                palabra = Serializador.deserializar(received);
                word = Palabra.getVAlor(palabra);
                puntaje = Palabra.getPuntaje(palabra);
                ...
                if(validacion.validarPalabra(word)==true) {
                	toreturn = "La palabra enviada es valida y tiene un puntaje de: ?????";
